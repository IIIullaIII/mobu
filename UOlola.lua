...
minetest.register_node("mobu:UOlola2", {
	...
	tiles = {"new_uolola.png"},
	drawtype="mesh",
	drop="mobu:UOlola",
	mesh="new_uolola2.obj",
	paramtype="light",
	paramtype2="facedir",
	sounds ="mobu:morso",
...
--[[minetest.register_abm({
	...
	action = function(pos, node, active_object_count, active_object_count_wider)
		minetest.set_node({x = pos.x, y = pos.y + 1, z = pos.z}, {name = "mobu:UOlola_spawner"})
	end
})]]
mobu:register_spawn("mobu:UOlola", {"default:dirt_with_grass", "ethereal:prairie_dirt"}, 20, 10, 15000, 2, 31000)
